...
import menuSidebarEngineer from '../../../ultils/menuSidebarEngineer';
    ...
    return (
        <div className='w-full min-w-60 flex justify-center pl-2'>
            <div className='w-full justify-center rounded-xl border-2 shadow-md bg-white'>
                ...
                <div className=' bg-green-400 absolute left-0 top-0 p-2 rounded-xl text-white text-xs uppercase font-semibold'>Engineer</div>
                ...
                <div className=' m-5 flex flex-col gap-9 '>
                    {
                        menuSidebarEngineer.map((item, _) => {
                            return (
                                <NavLink
                                    key={item.id}
